...
but1 = Button(text="", width=5, pady=5, bg="#ff0000")
but2 = Button(text="", width=5, pady=5, bg="#ff7d00")
but3 = Button(text="", width=5, pady=5, bg="#ffff00")
but4 = Button(text="", width=5, pady=5, bg="#00ff00")
but5 = Button(text="", width=5, pady=5, bg="#007dff")
but6 = Button(text="", width=5, pady=5, bg="#0000ff")
but7 = Button(text="", width=5, pady=5, bg="#7d00ff")
lab = Label(pady=20)
